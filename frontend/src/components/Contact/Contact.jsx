...
const Contact = () => {
  ...
  return (
    <div>
      ...
      <div className="flex max-[1000px]:flex-col justify-around items-center max-[1000px]:gap-8 gap-10 mt-4">
        ...
        <form className="contact-form flex flex-col gap-4 w-[50%] max-[1000px]:w-[70%]">
          <input
            type="text"
            placeholder="name"
